...
__conda_setup="$('/home/luis/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/luis/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/luis/anaconda3/etc/profile.d/conda.sh"
    else
...
export PATH="/home/luis/.cache/activestate/bin:$PATH"
